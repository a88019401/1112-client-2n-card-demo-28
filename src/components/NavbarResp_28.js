...
import Wrapper from '../assets/wrapper/NavbarResp_28';
            ...
            <li className="menu-item dropdown">
              ...
              <div className="sub-menu-wrapper slideInUp">
                <ul className="sub-menu">
                    <li className="menu-item"><Link to="/card_28">Static</Link></li>
                    <li className="menu-item"><Link to="/local_28">Local Json</Link></li>
                    <li className="menu-item"><Link to="/supabase_28">Supabase</Link></li>
                    <li className="menu-item"><Link to="/node_28">Node Server</Link></li>
                </ul>
              </div>
            </li>
            <li className="menu-item dropdown">
