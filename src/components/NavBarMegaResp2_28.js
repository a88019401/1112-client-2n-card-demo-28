              ...
              <ul className="menu-main">
                ...
                <li className="menu-item-has-children">
                  ...
                  <div className="sub-menu mega-menu mega-menu-column-4">
                    <div className="list-item text-center">
                      <Link to="#">
                        <img src="../../public/images/mega2/img/p1.jpg" alt="new Product" />
                        <h4 className="title">Product 1</h4>
                      </Link>
                    </div>
                    <div className="list-item text-center">
                      <Link to="#">
                        <img src="/imges/mega2/p2.jpg" alt="new Product" />
                        <h4 className="title">Product 2</h4>
                      </Link>
                    </div>
                    <div className="list-item text-center">
                      <Link to="#">
                        <img src="/imges/mega2/p3.jpg" alt="new Product" />
                        <h4 className="title">Product 3</h4>
                      </Link>
                    </div>
                    <div className="list-item text-center">
                      <Link to="#">
                        <img src="/imges/mega2/p4.jpg" alt="new Product" />
                ...
                <li className="menu-item-has-children">
                  ...
                  <div className="sub-menu mega-menu mega-menu-column-4">
                    ...
                    <div className="list-item">
                      <img src="./imges/mega2/shop1.jpg" alt="shop" />
                ...
                <li className="menu-item-has-children">
                  ...
                  <div className="sub-menu single-column-menu">
                    <ul>
                      <li><Link to="#">Static</Link></li>
                      <li><Link to="#">Local Json</Link></li>
                      <li><Link to="#">Node + Context</Link></li>
                    </ul>
                  </div>
                </li>
                <li className="menu-item-has-children">
